"""Live mirror of the portal "Configure AI" page — drives the laptop bot.
...
def build_directives():
    """Builds the portal-driven system-prompt instructions (string)."""
    config = get_config()
    lines = []
