  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="pointer-events-none absolute left-[8%] top-[10%] h-[420px] w-[420px] rounded-full bg-violet-500/[0.08] blur-[140px]"
      />

      <motion.div
        animate={{ scale: [1, 1.1, 1], x: [0, 40, 0], opacity: [0.25, 0.5, 0.25] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut" }}
        className="pointer-events-none absolute bottom-[5%] right-[5%] h-[450px] w-[450px] rounded-full bg-cyan-400/[0.07] blur-[150px]"
      />
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pb-20 lg:px-8 lg:pb-28">
        <div className="grid items-center gap-16 lg:grid-cols-[1.05fr_0.95fr] lg:gap-12">
          ...
          <div className="max-w-3xl">
            ...
            >
              <motion.span
                ...
                className="mr-2 h-1.5 w-1.5 rounded-full bg-cyan-400"
              />
          ...
          >
            {/* Glow */}
            <div className="absolute inset-10 rounded-full bg-cyan-400/[0.07] blur-[100px]" />

            {/* Orbit */}
            <motion.div
              animate={{ rotate: 360 }}
              transition={{ duration: 28, repeat: Infinity, ease: "linear" }}
              className="absolute inset-[5%] rounded-full border border-dashed border-cyan-400/[0.08]"
            />

            <motion.div
              animate={{ rotate: -360 }}
              transition={{ duration: 35, repeat: Infinity, ease: "linear" }}
              className="absolute inset-[15%] rounded-full border border-dashed border-violet-400/[0.07]"
            />
            ...
            <motion.div
              ...
              className="relative rounded-[28px] border border-white/[0.09] bg-[#0a1727]/90 p-4 shadow-2xl backdrop-blur-xl sm:p-5"
            >
              {/* Header */}
            ...
            <motion.div
              ...
              className="absolute -right-3 top-[18%] hidden rounded-xl border border-violet-400/15 bg-[#0b192b]/95 px-3 py-2.5 shadow-xl backdrop-blur-xl sm:block"
            >
            ...
            <motion.div
              ...
              className="absolute -left-4 bottom-[14%] hidden rounded-xl border border-cyan-400/15 bg-[#0b192b]/95 px-3 py-2.5 shadow-xl backdrop-blur-xl sm:block"
            >
  ...
  return (
    <div className="flex h-4 justify-center">
      <motion.div
        ...
        className="h-full w-px bg-gradient-to-b from-white/[0.08] to-cyan-400/30"
      />
    </div>
  );
}
