...
export default function AdminSidebar({
  ...
  return (
    <>
      ...
      {/* Mobile top bar */}
      <div className="fixed inset-x-0 top-0 z-40 flex items-center justify-between border-b border-white/[0.06] bg-[#060f1b]/90 px-4 py-3 backdrop-blur-xl lg:hidden">
        <BrandMark />
        <button
          type="button"
