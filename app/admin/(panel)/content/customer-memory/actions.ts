...
export async function updateCustomerMemoryContent(
  ...
  if (!values.context_items) {
    return { success: false, message: "Context items are required." };
  }
  ...
  return {
    success: true,
    message: "Saved — Customer Memory section updated on the website.",
  };
}
