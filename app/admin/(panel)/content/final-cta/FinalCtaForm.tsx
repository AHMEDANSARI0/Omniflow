...
import { updateFinalCtaContent, type ContentActionState } from "./actions";
...
export default function FinalCtaForm({ content }: { content: FinalCtaContent }) {
  ...
  return (
    <form action={formAction} className="space-y-6">
      ...
      {/* Notes card */}
      <div className="rounded-2xl border border-white/[0.06] bg-white/[0.015] p-6">
        <h2 className="mb-1 text-sm font-semibold text-white">Notes strip</h2>
        <p className="mb-5 text-xs text-slate-500">
