...
// Backend: `q` search param (contact name / number / message body), per-row
// `unread` flag, auto mark-read when a conversation is opened, lazy
// last_read_at column (self-migrating via ensure_tables), migration 009 file.
// Website: search box (debounced), unread dot on rows, no-match empty state.
//
